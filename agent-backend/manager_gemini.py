...
# Setup Tracer (Chỉ setup nếu chưa có để tránh lỗi Override)
...
class ResearchManager:
        ...
        try:
            ...
            for m in messages:
                ...
                if role in ["user", "assistant"] and content:
                    # --- XỬ LÝ ĐỘ DÀI TIN NHẮN ---
                    text_content = str(content)

                    # Nếu tin nhắn dài hơn 4000 ký tự 
                    # thì cắt bớt và thêm dấu hiệu nhận biết
            ...
            if zep_messages:
                ...
                print(f"🧠 Đã lưu {len(zep_messages)} tin nhắn vào Zep (Session: {chat_id})")
    ...
    async def run(self, query: Any, user_id: None, session_id: None) -> None:
        ...
        with tracer.start_as_current_span("Real estate research trace") as span:
            ...
            trace_url = "https://cloud.langfuse.com" # Hoặc f"{langfuse_host}"
