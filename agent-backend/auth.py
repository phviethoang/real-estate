...
username = urllib.parse.quote_plus("phamviethoanhlp_db_user")
password = urllib.parse.quote_plus("hoang2004a@")
# Kết nối MongoDB

uri = f"mongodb+srv://{username}:{password}@cluster0.kgq5pto.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
